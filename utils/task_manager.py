...
class TaskManager:
    ...
    def start_schedule_task(self, key: any, interval_seconds: float, action: callable, *args, **kwargs) -> asyncio.Task:
    ...
    async def start_single_schedule_task(
        ...
        return await self.start_single_async_task(key, scheduler, *args, **kwargs)
