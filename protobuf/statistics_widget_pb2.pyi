...
class RetrieveStatisticWidgetSettingsRequest(_message.Message):
    __slots__ = ("author_id", "setting_id", "updated_at")
    ...
    setting_id: int
    updated_at: str
    def __init__(self, author_id: _Optional[int] = ..., setting_id: _Optional[int] = ..., updated_at: _Optional[str] = ...) -> None: ...
