...
import protobuf.statistics_widget_pb2 as statistics__widget__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in statistics_widget_pb2_grpc.py depends on'
...
class StatisticWidgetSettingsServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RetrieveStatisticWidgetSettings = channel.unary_unary(
                ...
                request_serializer=statistics__widget__pb2.RetrieveStatisticWidgetSettingsRequest.SerializeToString,
                response_deserializer=statistics__widget__pb2.StatisticWidgetSettings.FromString,
...
def add_StatisticWidgetSettingsServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'RetrieveStatisticWidgetSettings': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=statistics__widget__pb2.RetrieveStatisticWidgetSettingsRequest.FromString,
                    response_serializer=statistics__widget__pb2.StatisticWidgetSettings.SerializeToString,
            ),
    }
...
class StatisticWidgetSettingsService(object):
    ...
    def RetrieveStatisticWidgetSettings(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/settings.StatisticWidgetSettingsService/RetrieveStatisticWidgetSettings',
            statistics__widget__pb2.RetrieveStatisticWidgetSettingsRequest.SerializeToString,
            statistics__widget__pb2.StatisticWidgetSettings.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
