...
import protobuf.campaigns_pb2 as campaigns__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + " but the generated code in campaigns_pb2_grpc.py depends on"
...
def add_CampaignServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("campaign.CampaignService", rpc_method_handlers)
