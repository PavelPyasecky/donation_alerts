...
VIDEOS_EXCHANGE = getenv("VIDEOS_EXCHANGE")
VIDEO_STATUS_QUEUE = getenv("VIDEO_STATUS_QUEUE")
...
CHECK_MAX_GROUPS_DURATION_INTERVAL = int(getenv("CHECK_MAX_GROUPS_DURATION_INTERVAL", 60))
CHECK_NEW_WIDGET_VIDEO_SETTINGS_INTERVAL = int(getenv("CHECK_NEW_WIDGET_VIDEO_SETTINGS_INTERVAL", 10))
CHECK_NEW_WIDGET_VIDEOS_INTERVAL = int(getenv("CHECK_NEW_WIDGET_VIDEOS_INTERVAL", 60))
CHECK_NEW_STATISTIC_WIDGET_SETTINGS_INTERVAL = int(getenv("CHECK_NEW_STATISTIC_WIDGET_SETTINGS_INTERVAL", 10))
